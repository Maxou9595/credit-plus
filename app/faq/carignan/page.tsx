...
export const metadata = {
  title: "FAQ Crédit Immobilier Carignan (08110) | Courtier Local Crédit Time",
  description:
    "Questions fréquentes sur le crédit immobilier à Carignan 08110. Taux, marché local, spécificités Ardennes. Votre courtier expert Crédit Time à Carignan.",
  keywords:
