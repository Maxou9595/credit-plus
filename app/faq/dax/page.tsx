...
export const metadata = {
  title: "FAQ Crédit Immobilier Dax (40100) | Courtier Local Crédit Time",
  description:
    "Questions fréquentes sur le crédit immobilier à Dax 40100. Taux, marché local, spécificités Landes. Votre courtier expert Crédit Time à Dax.",
  keywords:
