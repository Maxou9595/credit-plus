  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
            ...
            <div className="relative">
              ...
              {showAgencies && (
                <>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-72 bg-gradient-to-br from-[#1a1a1a] to-[#292929] border border-primary/40 rounded-xl shadow-2xl shadow-primary/30 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300 z-50">
                    <div className="p-2">
                      <a
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-[#292929] border-b border-primary/30 shadow-xl animate-in slide-in-from-top-2 duration-300">
            <div className="px-4 py-6 space-y-4">
              ...
              <a
                href="/demande-credit?type=consumer"
                onClick={closeMobileMenu}
                className="block text-white hover:text-primary transition-all duration-300 font-medium py-3 px-4 border-2 border-primary rounded-lg hover:bg-primary/10 text-center"
              >
                Simuler mon crédit
              </a>
              <a
